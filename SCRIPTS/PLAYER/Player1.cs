...
public class Player1 : MonoBehaviour
{
    ...
    {
        player1.velocity = new Vector2(horizontal * speed, player1.velocity.y); // Moves the player left and right
    }
    ...
    void CharacterMovement() // Function for the character's movement
    {
        ...
        {
            player1.velocity = new Vector2(player1.velocity.x, jumpingPower); // JUMP
        }
